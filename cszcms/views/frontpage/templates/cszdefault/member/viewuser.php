                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <p aria-hidden="true"><b><?php echo $this->Csz_model->getLabelLang('display_name') ?>:</b><br><?php echo ($users->name) ? $users->name : '-'; ?></p>
                            <p aria-hidden="true"><b><?php echo $this->Csz_model->getLabelLang('first_name') ?> - <?php echo $this->Csz_model->getLabelLang('last_name') ?>:</b><br><?php echo ($users->first_name) ? ucfirst($users->first_name) : '-'; ?> <?php echo ($users->last_name) ? ucfirst($users->last_name) : ''; ?></p>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <p aria-hidden="true"><b><?php echo $this->Csz_model->getLabelLang('gender') ?>:</b><br><?php echo ($users->gender) ? ucfirst($users->gender) : '-'; ?></p>
                            <p aria-hidden="true"><b><?php echo $this->Csz_model->getLabelLang('birthday') ?>:</b><br><?php echo ($users->birthday && $users->birthday != '0000-00-00') ? date('d F Y', strtotime($users->birthday)) : '-'; ?></p>
                            <p aria-hidden="true"><b><?php echo $this->Csz_model->getLabelLang('address') ?>:</b><br><?php echo($users->address) ? $users->address : '-'; ?></p>
                        </div>
                    </div>
                    <br>
                </div>
