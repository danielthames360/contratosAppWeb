<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-center"><span style="font-size:36px;color:#213047;font-family: 'Kaushan Script','Helvetica Neue',Helvetica,Arial,cursive;"><a href="<?php echo base_url()?>" target="_blank"><?php echo  $this->Headfoot_html->getLogo(); ?></a></span></div>
            <br><br><br>         
