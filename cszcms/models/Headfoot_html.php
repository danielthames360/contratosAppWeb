...
class Headfoot_html extends CI_Model
{
    ...
    public function admin_leftmenu($cur_page)
    {
        ...
        if (
            $this->Csz_auth_model->is_group_allowed('forms builder', 'backend') !== FALSE ||
        ...
        if (
            $this->Csz_auth_model->is_group_allowed('language', 'backend') !== FALSE ||
    ...
    public function memberleftMenu()
    {
        ...
        $html .= '<div class="card border-dark">
                <div class="card-header"><b><i class="glyphicon glyphicon-edit"></i> Menú</b></div>
                <div class="card-body">
                    <ul class="list-group">';
        // if($this->session->userdata('admin_type') == 'admin'){
        //     $html.= '<li role="presentation" class="list-group-item"><a href="'.$this->Csz_model->base_link().'/admin" target="_blank"><i class="glyphicon glyphicon-briefcase"></i> Administrar el sistema</a></li>';
        // }
        // if($this->Csz_auth_model->is_group_allowed('pm', 'frontend') !== FALSE){
        //     $html.= '<li role="presentation" class="list-group-item"><a href="'.$this->Csz_model->base_link().'/member/list"><i class="glyphicon glyphicon-list-alt"></i> Usuario </a></li>';
        // }
        $html .= '<li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/member"><i class="glyphicon glyphicon-user"></i> Tu perfil</a></li>
        <li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/member/listaPersonas"><i class="glyphicon glyphicon-tree-deciduous"></i> Personas </a></li>
        <li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/member/listaContratos"><i class="glyphicon glyphicon-list-alt"></i> Mis contratos </a></li>
        <li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/member/edit"><i class="glyphicon glyphicon-edit"></i> Editar tus datos</a></li>
        <li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/member/logout"><b><i class="glyphicon glyphicon-log-out"></i> Cerrar sesión</b></a></li>
        </ul>
                </div>
            </div></di>';
        /* Start Plugin Menu */
        ...
        if ($plugin_arr !== FALSE) {
            ...
            foreach ($plugin_arr as $value) {
                ...
                if ($plugin_member_menu) {
                    ...
                    if ($perm_chk !== FALSE) {
                        $plugin_menu .= '<li role="presentation" class="list-group-item"><a href="' . $this->Csz_model->base_link() . '/plugin/' . $this->Csz_model->getPluginConfig($value['plugin_config_filename'], 'plugin_urlrewrite') . '"><i class="glyphicon glyphicon-gift"></i> ' . $plugin_member_menu . '</a></li>';
                    }
                }
            }
            if ($plugin_menu) {
                $html .= '<div class="row"><div class="card border-dark">
                    <div class="card-header"><b><i class="glyphicon glyphicon-menu-hamburger"></i> ' . $this->Csz_model->getLabelLang('plugin_member_menu') . '</b></div>
                    <div class="card-body">
                        <ul class="list-group">
                        ' . $plugin_menu . '
                        </ul>
     ...
     * @return	string
     */
    public function getAdminContent($ori_content)
