...
class Csz_admin_model extends CI_Model{
    ...
    public function coreCss($more_css = '', $more_include = TRUE){
        ...
        $core_css.= link_tag(base_url('', '', TRUE).'assets/css/bootstrap-admin.min.css');
    ...
    public function coreJs($more_js = '', $more_include = TRUE){
        $core_js = '<script type="text/javascript" src="' . base_url('', '', TRUE) . 'assets/js/jquery.min.js"></script>';
