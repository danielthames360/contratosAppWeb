...
$route['admin/pages/viewPageAdmin'] = "admin/pages/viewPageAdmin";
$route['admin/pages/viewPageAdmin/:any'] = "admin/pages/viewPageAdmin";
$route['admin/pages/viewPageSaved'] = "admin/pages/viewPageSaved";
$route['admin/pages/viewPageSaved/:any'] = "admin/pages/viewPageSaved";
...
$route['contrato/vistaPrevia/:num'] = 'contrato/vistaPrevia';
$route['contrato/vistaPreviaClausulas/:num'] = 'contrato/vistaPreviaClausulas';
$route['contrato/reimprimirContrato/:num'] = 'contrato/reimprimirContrato';
$route['contrato/descargarContrato/:num'] = 'contrato/descargarContrato';


$route['contratosList'] = 'ContratosList';
$route['contrato/aprobacion_premium/:num'] = 'contrato/aprobacion_premium';
$route['contrato/aprobadoconexito'] = 'contrato/aprobadoconexito';
...
$route['member/listaPersonas'] = 'Member/listaPersonas';
$route['member/listaContratos'] = 'Member/listaContratos';
...
//Listas Ajax
$route['obtenerListasContratos'] = 'ContratosList/obtenerListas';
$route['comenzarContrato'] = 'ContratosList/comenzarContrato';
$route['obtenerPersonas'] = 'Member/obtenerPersonas';
$route['obtenerContratos'] = 'Member/obtenerContratos';
$route['guardarPersona'] = 'Member/guardarPersona';
